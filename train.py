...
def main(args):
    ...
    tf.flags.DEFINE_boolean("apply_mecab", args.apply_mecab, "apply mecab to datasets and train tokenizer")
...
if __name__ == '__main__':
    ...
    parser.add_argument('--apply_mecab', type=bool, help='apply mecab to datasets and train tokenizer')
